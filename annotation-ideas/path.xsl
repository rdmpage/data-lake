...
<!-- XSL that can output full paths to tp:treatment blocks -->
...
<!-- based on http://stackoverflow.com/a/5705457 and http://www.dpawson.co.uk/xsl/sect2/N6077.html#d9164e69 -->
...
<xsl:param name="path"/>
      <xsl:template name="print-step">
		...
		<xsl:value-of select="substring(concat('[', $precSiblings + 1, ']'), 
